...
CREATE TABLE "flights"."Flight" (
    ...
    "deparuter_time" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "user"."User" ADD CONSTRAINT "User_balanceId_fkey" FOREIGN KEY ("balanceId") REFERENCES "balance"."Balance"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
